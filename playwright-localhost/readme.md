...
2. Установить VSCode
3. Клонировать структуру проекта для тестирвоания - папки и настройки 
4. Инициализировать PlayWright в папке проекта
5. Проверить работу

# Принципы совместной работы по тестированию

Все тестировщики используют готовый репозиторий для создания тестов
