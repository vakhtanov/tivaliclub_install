...
Создаем ЧАТ и добавляем в нее бота  **@getmyid_bot**  

![ищем @my_id_bot](img/08.jpg)

Приложение покажет идентификатор чата. Записываем — он нам потребуется позже.  
...
**В ранее созданный чат добавляем созданного бота**

**СООБЩЕНИЯ БУДЕТ ПРИХОДИТЬ В ЭТОТ ЧАТ**
